...
<div>
    <details><summary style="font-size: large; font-weight: bold">주요 기능 구성</summary>
        <ol>
            <li><h5>Message Send (네이버 클라우드 sms 기능 사용)</h5>
...
<div>
    <details><summary style="font-size: large; font-weight: bold">기술 사용 이유</summary>
        ...
        <h3>Spring Security와 Redis 세션 로그인 + 로그인 유지</h3>
    </details>
</div>
...
<div>
    <details><summary style="font-size: large; font-weight: bold">리팩토링</summary>
